#property copyright "TTM FVG ATR v2"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_FVG_ATR_V2_"
#define DIR_BULL 1
#define DIR_BEAR -1
#define GRADE_C 1
#define GRADE_B 2
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM FVG ATR v2", TextColor);
...
void ScanFVGs(const int rates_total, const datetime &time[], const double &high[], const double &low[], const double &close[])
{
   ...
   for(int shift = maxShift; shift >= 1; shift--)
   {
      ...
      int grade = CalculateFVGGrade(top, bottom, atrValue);
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM FVG ATR v2");
