#property copyright "TTM FVG Grade v1"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_FVG_GRADE_V1_"
#define DIR_BULL 1
#define DIR_BEAR -1
#define GRADE_C 1
#define GRADE_B 2
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM FVG Grade v1", TextColor);
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM FVG Grade v1");
