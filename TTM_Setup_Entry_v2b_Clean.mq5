#property copyright "TTM Setup Entry v2b Clean"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_SETUP_ENTRY_V2B_CLEAN_"
#define DIR_BULL 1
#define DIR_BEAR -1
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM Setup Entry v2b Clean", TextColor);
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM Setup Entry v2b Clean");
