#property copyright "TTM FVG Cluster v4"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_FVG_CLUSTER_V4_"
#define DIR_BULL 1
#define DIR_BEAR -1
#define GRADE_C 1
#define GRADE_B 2
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM FVG Cluster v4", TextColor);
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM FVG Cluster v4");
