#property copyright "TTM FVG Alert v5"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_FVG_ALERT_V5_"
#define DIR_BULL 1
#define DIR_BEAR -1
#define GRADE_C 1
#define GRADE_B 2
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM FVG Alert v5", TextColor);
   ...
   DrawLabel(PREFIX + "DIAG_OBJECTS", 12, 164, "Objects created: " + IntegerToString(g_objectsCreated), TextColor);
   DrawLabel(PREFIX + "DIAG_FAILURES", 12, 182, "Create failures: " + IntegerToString(g_objectCreateFailures), TextColor);
   DrawLabel(PREFIX + "DIAG_ERROR", 12, 200, "Last object error: " + IntegerToString(g_lastObjectError), TextColor);
}
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM FVG Alert v5");
