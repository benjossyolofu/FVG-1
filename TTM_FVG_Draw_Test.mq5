#property copyright "TTM FVG Draw Test"
#property link      ""
#property version   "1.00"
#property indicator_chart_window
#property indicator_plots 0

#define PREFIX "TTM_FVG_DRAW_TEST_"
#define DIR_BULL 1
#define DIR_BEAR -1
...
{
   DrawLabel(PREFIX + "DIAG_TITLE", 12, 20, "TTM FVG Draw Test", InpTextColor);
...
int OnInit()
{
   IndicatorSetString(INDICATOR_SHORTNAME, "TTM FVG Draw Test");
